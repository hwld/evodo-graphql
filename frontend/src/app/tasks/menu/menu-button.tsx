    ...
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          ...
          text-neutral-200 transition-all duration-200 focus-within:outline-none focus-within:ring-2 focus-within:ring-neutral-900 focus-within:ring-offset-2 hover:bg-neutral-700"
        >
