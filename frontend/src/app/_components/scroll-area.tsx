  ...
  return (
    <RadixScrollArea.Root {...props} ref={ref}>
      ...
      <RadixScrollArea.Scrollbar
        className="data-[state=visible]:animate-showScrollbar data-[state=hidden]:animate-hideScrollbar flex h-full w-[13px] touch-none select-none bg-transparent px-[4px] py-[10px]"
