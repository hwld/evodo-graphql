...
export const Textarea: React.FC<Props> = forwardRef<HTMLTextAreaElement, Props>(
  function Textarea({ label, id, error, ...props }, ref) {
    const textareaClass = {
      base: 'min-h-[150px] resize-none rounded border bg-neutral-100 px-3 py-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 placeholder:text-neutral-400 disabled:cursor-not-allowed disabled:opacity-50',
